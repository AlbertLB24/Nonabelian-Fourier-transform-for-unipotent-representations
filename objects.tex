...
\begin{definition}
    An irreducible smooth admissible representation $(\pi,V)$ of $G$ is \textit{unipotent} if there exists some parahoric subgroup $K$ of $G$ such that $V^{U_K}$ contains a cuspidal unipotent representation of the finite group $K/U_K$.
\end{definition}
...
\begin{lemma}
    ...
    \begin{enumerate}
        \item If there is some parahoric subgroup $K$ such that $V^{U_K}$ contains a non-cuspidal unipotent representation of $K/U_K$, then $(\pi,V)$ is a unipotent representation of $G$.  
        \item Conversely, if $(\pi,V)$ is a unipotent representation of $G$, then all irreducible $K/U_K$-subrepresentations of $V^{U_K}$ are unipotent.
    \end{enumerate}
\end{lemma}
